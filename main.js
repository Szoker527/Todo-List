...
function displayTasks(parent, topic) {
    let arrayTopic;
    if (topic === "allTasks") {
        arrayTopic = _arrays__WEBPACK_IMPORTED_MODULE_0__.dateArray
    }
    if (topic === "todayTasks") {
        const today = new Date();
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(today, 'yyyy-MM-dd');
        arrayTopic = (0,_arrays__WEBPACK_IMPORTED_MODULE_0__.findDateArray)(formattedDate)
    }
    if (topic === "weekTasks") {
        arrayTopic = (0,_arrays__WEBPACK_IMPORTED_MODULE_0__.nextWeek)()
    }
...
function home() {
    ...
    ;(0,_functions_displayTasks__WEBPACK_IMPORTED_MODULE_1__["default"])(menu, "allTasks")
}
...
function todayPage() {
    const menu = document.querySelector(".display-menu")
    ;(0,_functions_displayTasks__WEBPACK_IMPORTED_MODULE_0__["default"])(menu, "todayTasks")
}
...
function Week() {
    const menu = document.querySelector(".display-menu")
    ;(0,_functions_displayTasks__WEBPACK_IMPORTED_MODULE_1__["default"])(menu, "weekTasks")
}
...
/* harmony import */ var _pages_modal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./pages/modal */ "./src/pages/modal.js");
...
(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2014-02-03", "Work", "What to do", "wdadadadadaada", "low")
;(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2014-01-04", "Relax", "Play games", "xxxxxxxxxxxxxxxxx", "medium")
;(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2014-03-05", "Relax", "dsdsds", "xxxxxxxxxxxxxxxxx", "high")
;(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2023-04-14", "Relax", "dsdsds", "xxxxxxxxxxxxxxxxx", "high")
;(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2023-04-16", "Relax", "xxxxxx", "gggggg", "low")
;(0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)("2023-04-15", "Relax", "xxxxxx", "gggggg", "low")
...
homeBtn.addEventListener("click", function() {
    ;(0,_functions_render__WEBPACK_IMPORTED_MODULE_5__.render)()
    ;(0,_pages_home__WEBPACK_IMPORTED_MODULE_0__["default"])()
    console.log("home")
})
...
addBtn.addEventListener("click", function() {
    ...
    ;(0,_pages_modal__WEBPACK_IMPORTED_MODULE_6__["default"])()
    ...
    form.addEventListener('submit', (event) => {
        ...
        (0,_functions_tasks__WEBPACK_IMPORTED_MODULE_8__.createTask)(formDateSubmit.value, "Work", formTitle.value, formDescription.value , selectedPriority)
        ;(0,_functions_render__WEBPACK_IMPORTED_MODULE_5__.render)()
        ;(0,_pages_home__WEBPACK_IMPORTED_MODULE_0__["default"])()
      });
