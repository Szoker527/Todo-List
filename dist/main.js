...
/* harmony import */ var _firstLoad__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./firstLoad */ "./src/functions/firstLoad.js");
...
function displayTasks(array) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_9__["default"])(date, 'MMM d');
        const clonedNode = originalNode.cloneNode(true);
        clonedNode.id = i;
        ...
        for (let i = 0; i < clonedNodeChildren.length; i++) {
          ...
          if (child.id.toLowerCase() === 'trash-icon') {
            child.addEventListener('click', function(event) {
              ...
              ;(0,_firstLoad__WEBPACK_IMPORTED_MODULE_7__.firstLoad)()
              console.log(array)
            });
          }
        }
...
function displayProjects(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    listItem.addEventListener('click', function() {
      ...
      ;(0,___WEBPACK_IMPORTED_MODULE_8__.deleteSelect)()
...
notes.addEventListener("click", function() {
  ;(0,_functions_displayTasks__WEBPACK_IMPORTED_MODULE_6__.displayNotes)((0,_functions_arrays__WEBPACK_IMPORTED_MODULE_7__.notesTasks)())
  deleteSelect()
