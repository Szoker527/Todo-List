...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".modal-detail {\n    display: none;\n    position: fixed;\n    z-index: 1;\n    overflow: auto;\n    height: 100vh;\n    width: 100vw;\n    justify-content: center;\n    align-items: center;\n    background-color: rgb(0,0,0); /* Fallback color */\n    background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n}\n\n\n\n.main-detail {\n    height: 20rem;\n    width: 35rem;\n    background-color: #fefefe;\n    padding: 20px;\n    border: 4px solid var(--primary-color);\n}\n\n\n.display-task {\n  position: relative;\n    display: flex;\n    flex-direction: column;\n    font-family: \"Ubuntu-light\", sans-serif;\n  }\n\n  .tasks-title {\n    flex: 1;\n    font-size: 2.5rem;\n  }\n\n  .task-info {\n    font-size: 1.5rem;\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    margin: 5px 0;\n  }\n  \n  .task-info > span {\n    font-weight: bold;\n    margin-right: 10px;\n  }", "",{"version":3,"sources":["webpack://./src/styles/modalsDetail.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,eAAe;IACf,UAAU;IACV,cAAc;IACd,aAAa;IACb,YAAY;IACZ,uBAAuB;IACvB,mBAAmB;IACnB,4BAA4B,EAAE,mBAAmB;IACjD,iCAAiC,EAAE,qBAAqB;AAC5D;;;;AAIA;IACI,aAAa;IACb,YAAY;IACZ,yBAAyB;IACzB,aAAa;IACb,sCAAsC;AAC1C;;;AAGA;EACE,kBAAkB;IAChB,aAAa;IACb,sBAAsB;IACtB,uCAAuC;EACzC;;EAEA;IACE,OAAO;IACP,iBAAiB;EACnB;;EAEA;IACE,iBAAiB;IACjB,aAAa;IACb,mBAAmB;IACnB,mBAAmB;IACnB,aAAa;EACf;;EAEA;IACE,iBAAiB;IACjB,kBAAkB;EACpB","sourcesContent":[".modal-detail {\n    display: none;\n    position: fixed;\n    z-index: 1;\n    overflow: auto;\n    height: 100vh;\n    width: 100vw;\n    justify-content: center;\n    align-items: center;\n    background-color: rgb(0,0,0); /* Fallback color */\n    background-color: rgba(0,0,0,0.4); /* Black w/ opacity */\n}\n\n\n\n.main-detail {\n    height: 20rem;\n    width: 35rem;\n    background-color: #fefefe;\n    padding: 20px;\n    border: 4px solid var(--primary-color);\n}\n\n\n.display-task {\n  position: relative;\n    display: flex;\n    flex-direction: column;\n    font-family: \"Ubuntu-light\", sans-serif;\n  }\n\n  .tasks-title {\n    flex: 1;\n    font-size: 2.5rem;\n  }\n\n  .task-info {\n    font-size: 1.5rem;\n    display: flex;\n    flex-direction: row;\n    align-items: center;\n    margin: 5px 0;\n  }\n  \n  .task-info > span {\n    font-weight: bold;\n    margin-right: 10px;\n  }"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony export */   "clearLocalArray": () => (/* binding */ clearLocalArray),
...
/* harmony export */   "returnLocalToArray": () => (/* binding */ returnLocalToArray),
...
/* harmony import */ var _assets_images_edit_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../assets/images/edit.svg */ "./src/assets/images/edit.svg");
/* harmony import */ var _assets_images_edit_svg__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_assets_images_edit_svg__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _assets_images_trash_svg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../assets/images/trash.svg */ "./src/assets/images/trash.svg");
/* harmony import */ var _assets_images_trash_svg__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_assets_images_trash_svg__WEBPACK_IMPORTED_MODULE_7__);
...
function displayTasks(array) {
    ...
    svgEdit.innerHTML = (_assets_images_edit_svg__WEBPACK_IMPORTED_MODULE_6___default());
    svgTrash.innerHTML = (_assets_images_trash_svg__WEBPACK_IMPORTED_MODULE_7___default());
    ...
    for (let i = 0; i < array.length; i++) {
      ...
      const formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(date, 'MMM d');
      const clonedNode = originalNode.cloneNode(true);
      clonedNode.id = i;
...
function firstLoad() {
    ...
    ;(0,_arrays__WEBPACK_IMPORTED_MODULE_0__.updateArrays)((0,_arrays__WEBPACK_IMPORTED_MODULE_0__.returnLocalToArray)("taskArray"), "task")
    ;(0,_arrays__WEBPACK_IMPORTED_MODULE_0__.updateArrays)((0,_arrays__WEBPACK_IMPORTED_MODULE_0__.returnLocalToArray)("noteArray"), "note")
    ;(0,_arrays__WEBPACK_IMPORTED_MODULE_0__.updateArrays)((0,_arrays__WEBPACK_IMPORTED_MODULE_0__.returnLocalToArray)("projectArray"), "project")
...
resetBtn.addEventListener("click", _functions_arrays__WEBPACK_IMPORTED_MODULE_6__.clearLocalArray);
...
function modalAdd() {
    ...
    toDoForm(smallMain)
    ;(0,_functions_firstLoad__WEBPACK_IMPORTED_MODULE_0__.firstLoadModal)()
...
function toDoForm(parent) {
    ...
    function onSubmit(event) {
       ...
       (0,_functions_tasks__WEBPACK_IMPORTED_MODULE_2__.createTask)(formData.get('date'), formData.get('titles'), formData.get('descriptions'), selectedPriority);
       form.reset();
       const modal = document.querySelector(".modal");
       modal.style.display = "none";
...
function projectForm(parent) {
    ...
    function onSubmit(event) {
        event.preventDefault();
        const formData = new FormData(form);
        (0,_functions_tasks__WEBPACK_IMPORTED_MODULE_2__.createProject)(formData.get('project-title'));
        form.reset();
        const modal = document.querySelector(".modal");
        modal.style.display = "none";
        (0,_functions_firstLoad__WEBPACK_IMPORTED_MODULE_0__.firstLoad)();
...
function noteForm(parent) {
    ...
    function onSubmit(event) {
        event.preventDefault();
        const formData = new FormData(form);
        (0,_functions_tasks__WEBPACK_IMPORTED_MODULE_2__.createNotes)(formData.get('note'), formData.get('note-des'));
        form.reset();
        const modal = document.querySelector(".modal");
        modal.style.display = "none";
        (0,_functions_firstLoad__WEBPACK_IMPORTED_MODULE_0__.firstLoad)();
